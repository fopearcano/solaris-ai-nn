...
- external collector concept: external magnetometer logger produces field features
- expected feature schema: `magnetic_event`
- output envelope path: `.solaris_ai_nn_live/inbox/magnetic/magnetic.jsonl`
...
```json
{
  "event_id": "FSE_65261f89c6",
  "feeder_id": "magnetic_feeder",
  "source_id": "magnetic_source",
